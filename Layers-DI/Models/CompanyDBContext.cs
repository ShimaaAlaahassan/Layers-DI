...
namespace Layers_DI.Models
{
    public class CompanyDBContext:DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-539NPC2 ;Initial Catalog=Identity;Integrated Security=True;TrustServerCertificate = True;");
